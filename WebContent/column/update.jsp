...
<div class="header">
    <div class="img"></div>
    <div class="con">当前位置：栏目管理-修改</div>
    <div class="bt_return">
        <input class="return" type="button" value="返回列表" onclick="window.location.href='columnqueryall.do'">
    </div>
</div>
<div class="main">
    <form action="columnupdate.do?cid=${col.id }" method="post" onsubmit="return chksubmit()">
        <table width="100%" border="0" cellspacing="1" class="tab">
            <tr>
                ...
                <td class="t2">
                    <input type="text" value="${col.columnname }" name="columnname" id="col" onblur="chkcolumnname()"/>
                    <span id="sp1"></span>
                </td>
            </tr>
            <tr>
                <td class="t1">上级栏目:</td>
                    <td class="t2">
                        ...
                        <c:forEach items="${columns  }" var="cols">
                        <c:if test="${col.upchannel!=0&&cols.id!=col.id&&cols.upchannel==0}">
           	...
           	<tr>
                    ...
                    <td class="t2">
                        <input type="text" value="${col.corder }" name="corder" id="cor" onblur="chkcorder()"/>
                        <span id="sp2"></span>
                    </td>
                </tr>
            <tr>
