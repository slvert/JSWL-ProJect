...
<body>
    <div class="header">
        <div class="img"></div>
        <div class="con">当前位置：用户管理-新增</div>
        <div>
            <form>
    ...
    <div class="main">
        ...
        <form action="useradd.do" method="post" onsubmit="return chksubmit()">
            <table width="100%" border="0" cellspacing="1" class="tab">
                <tr>
                    ...
                    <td class="t2">
                        <input type="text" name="loginname" id="ln"/>
                        <span id="sp3"></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="t2">
                        <input type="password" name="pwd1" id="pw1" onblur="chkpw()"/>
                        <span id="sp0"></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="t2">
                        <input type="password" name="pwd2" id="pw2" onblur="chkpwd()"/>
                        <span id="sp1"></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="t2">
                        <input type="text" name="realname" id="real" onblur="chkreal()"/>
                        <span id="sp2"></span>
                    </td>
                </tr>
                <tr>
