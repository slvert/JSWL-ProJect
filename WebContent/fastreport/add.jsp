...
<body>
    <div class="header">
        <div class="img"></div>
        <div class="con">当前位置：快报管理-新增</div>
        <div>
            <form>
    ...
    <div class="main">
        <form action="../fastreportadd.do" method="post" onsubmit="return chksubmit()">
            <table width="100%" border="0" cellspacing="1" class="tab">
                ...
                <tr>
                    ...
                    <td class="t2">
                        <input type="text" name="ctime" readonly="readonly" onclick="WdatePicker()" id="bir"/>
                    </td>
                </tr>
                <tr>
                    <td class="t1">
                    ...
                    <td class="t2">
                        <input type="text" name="cman" id="cman" onblur="chkcman()"/>
                        <span id="sp3"></span>
                    </td>
                </tr>
                <tr>
